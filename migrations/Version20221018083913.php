 ...
 */
final class Version20221018083913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD lieu_id INT NOT NULL, ADD etat_id INT NOT NULL, ADD site_id INT DEFAULT NULL, ADD organisateur_id INT NOT NULL, DROP etat');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat VARCHAR(255) NOT NULL, DROP lieu_id, DROP etat_id, DROP site_id, DROP organisateur_id');
    }
}
