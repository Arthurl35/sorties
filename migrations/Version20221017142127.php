 ...
 */
final class Version20221017142127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie ADD etat_id INT NOT NULL, ADD site_id INT DEFAULT NULL, ADD organisateur_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sortie DROP etat_id, DROP site_id, DROP organisateur_id');
    }
}
